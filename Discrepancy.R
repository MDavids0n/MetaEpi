...
# MORTALITY
Obj2_mort<-as.data.table(read.xlsx(paste0("C:\\Users\\Mauricia Davidson\\METHODS Dropbox\\Mauricia Davidson\\preprint-journal.xlsx"),
...
Obj2_CI<-as.data.table(read.xlsx(paste0("C:\\Users\\Mauricia Davidson\\METHODS Dropbox\\Mauricia Davidson\\preprint-journal.xlsx"),
...
# WHO SCORE 7 & ABOVE
Obj2_WHO7<-as.data.table(read.xlsx(paste0("C:\\Users\\Mauricia Davidson\\METHODS Dropbox\\Mauricia Davidson\\preprint-journal.xlsx"),
...
# ADVERSE EVENTS
Obj2_AE<-as.data.table(read.xlsx(paste0("C:\\Users\\Mauricia Davidson\\METHODS Dropbox\\Mauricia Davidson\\preprint-journal.xlsx"),
...
Obj2_SAE<-as.data.table(read.xlsx(paste0("C:\\Users\\Mauricia Davidson\\METHODS Dropbox\\Mauricia Davidson\\preprint-journal.xlsx"),
...
All101<-as.data.table(fread(paste0("C:\\Users\\Mauricia Davidson\\METHODS Dropbox\\Mauricia Davidson\\preprint-journal.csv"),na.strings=c("*")))
